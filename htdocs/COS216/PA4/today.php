...
<head>
    ...
    <title>Daybreak News | Today</title>
</head>
<body id="body" class="light">
    <?php include 'templates/header.php'; 
        // $api = $_SESSION['api'];
        // if (isset($_SESSION['api']))
        //     echo "<script>alert('Your API is : $api')</script>";
    ?>
        ...
        <section class="top d-flex flex-column align-items-center">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="page-subheader">Today</p>
                </div>
                
            </div>
            <form class="d-flex flex-column align-items-center">
                <div>
                    <input type="search" class="search-bar" placeholder="What's happening today...">
                </div>
                <div class="filter">
                    <small>Filter by:</small>
                    <select name="dropdown-category" onchange="filter()" id="dropdown-category">
                        <option disabled selected>Category</option>
                        <option value="all">all</option>
                    </select>
                    <select name="dropdown-tags" onchange="tagFilter()" id="dropdown-tags">
                        <option disabled selected>Tag</option>
                        <option value="all">all</option>
                    </select>
                    <span id="save-button" onclick="updatePreference()">Save</span>
                </div>
            </form>
        </section>
            ...
            <div class="today-article">
                <a href="" target="_blank" title="">
                    <article>
                        ...
                        <div class="tags">
                            <small class="section">loading</small>
                            <small class="sub-section">loading</small>
                        </div>
                        <p class="description"><img src="img/p-loader.gif" class="p-loader" alt=""></p>
    ...
    <?php 
        ...
        $session_value=(isset($_SESSION['api']))?$_SESSION['api']:'4b686968df41db5fb37a02cf25ac';
    ?>
    <script type="text/javascript">
        const apiKey ='<?php echo $session_value;?>';
